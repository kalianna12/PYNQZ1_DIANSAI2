...
#
# Script generated by Vivado on Sat Mar 08 16:23:05 +0800 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fixed2floating_B.sh
...
#
# Usage        : fixed2floating_B.sh
#                fixed2floating_B.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fixed2floating_B.sh [-reset_run]
#                fixed2floating_B.sh [-reset_log]
#                fixed2floating_B.sh [-help]
#
...
#                script (type 'fixed2floating_B.sh -help' for more information).
#
...
# script info
echo -e "fixed2floating_B.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fixed2floating_B.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fixed2floating_B xil_defaultlib.glbl -o fixed2floating_B_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fixed2floating_B_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fixed2floating_B_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fixed2floating_B_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fixed2floating_B.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fixed2floating_B.sh [-help]\n\
Usage: fixed2floating_B.sh [-step]\n\
Usage: fixed2floating_B.sh [-lib_map_path]\n\
Usage: fixed2floating_B.sh [-reset_run]\n\
Usage: fixed2floating_B.sh [-reset_log]\n\
Usage: fixed2floating_B.sh [-keep_index]\n\
Usage: fixed2floating_B.sh [-noclean_files]\n\n\
