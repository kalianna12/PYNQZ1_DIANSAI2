...
#
# Script generated by Vivado on Sat Mar 08 15:23:59 +0800 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : floating2fixed_1.sh
...
#
# Usage        : floating2fixed_1.sh
#                floating2fixed_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                floating2fixed_1.sh [-reset_run]
#                floating2fixed_1.sh [-reset_log]
#                floating2fixed_1.sh [-help]
#
...
#                script (type 'floating2fixed_1.sh -help' for more information).
#
...
# script info
echo -e "floating2fixed_1.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./floating2fixed_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.floating2fixed_1 xil_defaultlib.glbl -o floating2fixed_1_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./floating2fixed_1_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key floating2fixed_1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc floating2fixed_1_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./floating2fixed_1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: floating2fixed_1.sh [-help]\n\
Usage: floating2fixed_1.sh [-step]\n\
Usage: floating2fixed_1.sh [-lib_map_path]\n\
Usage: floating2fixed_1.sh [-reset_run]\n\
Usage: floating2fixed_1.sh [-reset_log]\n\
Usage: floating2fixed_1.sh [-keep_index]\n\
Usage: floating2fixed_1.sh [-noclean_files]\n\n\
