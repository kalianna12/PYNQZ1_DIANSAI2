...
## Second SPI Slave from ESP32-P4 using PmodB P1-P4
## PmodB1 / W14 = esp_spi_mosi
## PmodB2 / Y14 = esp_spi_miso
## PmodB3 / T11 = esp_spi_sclk
## PmodB4 / T10 = esp_spi_cs_n
set_property PACKAGE_PIN W14 [get_ports esp_spi_mosi]
set_property IOSTANDARD LVCMOS33 [get_ports esp_spi_mosi]

set_property PACKAGE_PIN Y14 [get_ports esp_spi_miso]
set_property IOSTANDARD LVCMOS33 [get_ports esp_spi_miso]

set_property PACKAGE_PIN T11 [get_ports esp_spi_sclk]
set_property IOSTANDARD LVCMOS33 [get_ports esp_spi_sclk]

set_property PACKAGE_PIN T10 [get_ports esp_spi_cs_n]
