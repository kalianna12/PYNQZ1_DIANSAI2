...
module dds_core #(
    parameter [31:0] FWORD            = 32'd171799,   // default 1 kHz @ 25 MSPS sample_tick
    parameter [31:0] SWEEP_FWORD_MIN  = 32'd171799,   // 1 kHz @ 25 MSPS
    parameter [31:0] SWEEP_FWORD_MAX  = 32'd17179869, // 100 kHz @ 25 MSPS
    parameter [31:0] SWEEP_FWORD_STEP = 32'd171799,   // 1 kHz step
    parameter [31:0] SWEEP_HOLD_TICKS = 32'd250000    // 10 ms at 25 MSPS sample_tick
) (
    input  wire        clk,
    input  wire        rst,
    input  wire        dds_en,
